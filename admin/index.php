...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto px-4 py-6">
            ...
            <nav class="mt-4">
                <ul class="flex space-x-4">
                    ...
                    <li><a href="../register/" class="text-gray-600 hover:text-gray-800">Seller information</a></li>
    ...
    <div class="container mx-auto p-4">
        ...
        <div id="artisan-list" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-4">
                <img src="../images/artisan3.jpg" alt="Michael Brown" class="rounded-t-lg w-full">
