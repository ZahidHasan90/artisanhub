    ...
    <section>
      ...
      <div id="products" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
          <img src="images/watermelon.jpg" alt="Product 1" class="w-full h-48 object-cover">
          <div class="p-4">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
          <img src="images/kiwi.jpg" alt="Product 2" class="w-full h-48 object-cover">
          <div class="p-4">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
          <img src="images/lichi.jpg" alt="Product 3" class="w-full h-48 object-cover">
          <div class="p-4">
